...
const Card = ({ handleMood }) => {
  return (
    <div className="grid grid-cols-2 gap-5 mt-10 md:grid-cols-4 md:gap-10">
      <div
        className="flex flex-col items-center p-5 rounded-2xl bg-orange-888 w-full h-52 cursor-pointer"
      ...
      <div
        className="flex flex-col items-center p-5 rounded-2xl bg-blue-888 w-full h-52 cursor-pointer"
      ...
      <div
        className="flex flex-col items-center p-5 rounded-2xl bg-green-888 w-full h-52 cursor-pointer"
      ...
      <div
        className="flex flex-col items-center p-5 rounded-2xl bg-pink-888 w-full h-52 cursor-pointer"
